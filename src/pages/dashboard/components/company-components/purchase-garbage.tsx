  ...
  return (
    <div className="flex flex-col items-center justify-start h-full bg-white/30 shadow-xl rounded-xl p-4">
      ...
      <motion.p className="text-gray-500">
        Transform waste into wealth! By purchasing recyclable garbage, your
        company can reduce environmental impact and unlock a profitable revenue
        stream. Embrace sustainability—turn trash into treasure today! ♻️
      </motion.p>
