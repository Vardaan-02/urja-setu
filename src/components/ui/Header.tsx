    ...
    <header className="absolute inset-x-0 top-0 z-50">
      ...
      >
        ...
        <div className="hidden lg:flex lg:gap-x-12">
          {navigation.map((item) => (
            <a
              key={item.name}
              href={item.href}
              className="text-gray-900 hover:translate-y-1 hover:p-1 transition duration-300 font-bold text-xl"
            >
              {item.name}
            </a>
          ))}
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a
            href="#"
            className="text-xl font-semibold text-gray-900 hover:underline transition duration-300 p-2"
          >
